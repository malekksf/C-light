...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/CourseFixtures.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/VideoFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CourseFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\RatingFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\VideoFixtures(), 'groups' => []]]);
