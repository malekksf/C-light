...
class __TwigTemplate_951a21b1b7c549d1ed253e90493a1a46664107da554016ebec8b133c2421ff75 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_slides($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["videos"]) || array_key_exists("videos", $context) ? $context["videos"] : (function () { throw new RuntimeError('Variable "videos" does not exist.', 3, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["video"]) {
            // line 4
            echo "\t\t<p>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["video"], "name", [], "any", false, false, false, 4), "html", null, true);
            echo "</p>
\t\t<p>";
            // line 5
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["video"], "url", [], "any", false, false, false, 5), "html", null, true);
            echo "</p>
\t";
        }
    ...
    {
        return array (  78 => 5,  73 => 4,  68 => 3,  58 => 2,  35 => 1,);
    }
...
\t{% endfor %}
{% endblock %}
", "video/index.html.twig", "/home/malek/projets-symfony/C-light/templates/video/index.html.twig");
    }
}
